...
./bin/python3.8 -m pip install -e git+https://github.com/s0tfs/stable-diffusion@main#egg=latent-diffusion git+https://github.com/CompVis/taming-transformers.git@master#egg=taming-transformers git+https://github.com/openai/CLIP.git@main#egg=clip
